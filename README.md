...
| Scene- or relationship-mismatched register | Adjust only pronouns, honorifics, formality, or conversational style while preserving meaning and responsibility | Slack: `こちらの案について、ご意見をお聞かせください。` → `この案、どう思いますか？` | Customer email: `見積書、見ました。OKです。` → `見積書を拝見しました。内容に問題ありません。` |
